      ...
      <>
        <div className="Signup">
          ...
          <div className="Mobilecon">
            <Form>
              <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label className="Formtitlecon">
                  <h2 className="Formtitle">Verify Your Phone Number </h2>
                </Form.Label>
            ...
            <div className="MVtextcon">
              <h2 className="Formtitle">Didn't Receive the Code?</h2>
              <span className="SUsignin"> Request Again</span>
            </div>
          </div>
          <div className="SUbuttoncon">
            <Nav.Link className="SUbut" as={Link} to="/UserInformation">
